About h2o-lightwave-web-feedstock
=================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/h2o-lightwave-web-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/h2o-lightwave-web-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add h2o-lightwave-web
# for installing globally
pixi global install h2o-lightwave-web
```
...
It is possible to list all of the versions of `h2o-lightwave-web` available on your platform:
...
```
pixi search h2o-lightwave-web --channel conda-forge
```
